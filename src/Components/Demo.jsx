...
const Demo = () => {
    ...
    useEffect(() => {
        const articlesFromLocalStorage = JSON.parse(
            localStorage.getItem('articlesAiSummarize')
        )
    ...
    const handleSubmit = async (e) => {
        ...
        if (data?.summary) {
            ...
            localStorage.setItem('articlesAiSummarize', JSON.stringify(updatedAllArticles))
        }
    }
    ...
    return (
        <section className="mt-16 w-full max-w-xl">
            ...
            {/* Display Results  */}
            <div className="m-y10 max-w-full flex justify-center items-center">
                {isFetching ? (
                    <img src={loader} alt="loader" className="w-20 h-20 object-contain" />
                ): error ? (
                    <p className="font-inter font-bold text-black text-center"> Well, that wasn't supossed to happen...
                    <br />
                    ...
                    article.summary && (
                        <div className="flex flex-col gap-3">
                            ...
                            <div className="summary_box mb-5">
